...
export function DataRetentionSettings() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: 'Data retention settings saved successfully!',
      });
    } catch {
      setMessage({
        type: 'error',
  ...
  const handleDataCleanup = async () => {
    setMessage({
      type: 'success',
      text: 'Data cleanup process initiated. This may take several minutes.',
    });
  };
    ...
    <div className='space-y-6'>
        ...
        <div className='space-y-4'>
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateConfig('autoDeleteEnabled', checked)
              }
            />
          </div>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateConfig('archiveOldData', checked)
              }
            />
          </div>
        </div>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-2'>
          <Label htmlFor='anonymizeAfterDays'>
            Anonymize Personal Data After (days)
          </Label>
          <Input
          ...
          <p className='text-xs text-muted-foreground'>
            Personal identifiers will be removed after this period for
            compliance
          </p>
        </div>
      </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete data that exceeds the retention
                  policies. This action cannot be undone. Are you sure you want
                  to continue?
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
