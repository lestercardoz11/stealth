      ...
      <DialogContent className='max-w-3xl max-h-[85vh] flex flex-col'>
        <DialogHeader className='pb-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Choose documents to provide context for your AI assistant. Selected
            documents will be analyzed to provide relevant responses.
          </p>
        </DialogHeader>
          ...
          <div className='text-sm text-muted-foreground'>
            {selectedDocuments.length > 0 ? (
              <span className='text-primary font-medium'>
                ...
                {selectedDocuments.length !== 1 ? 's' : ''} will be used for RAG
                context
              </span>
            ) : (
              <span>
                No documents selected - AI will provide general responses
              </span>
            )}
          </div>
