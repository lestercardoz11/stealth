        ...
        <div className="p-4 border-b bg-background">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="font-semibold">Stealth AI Assistant</h2>
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">Welcome to Stealth AI</h3>
                <p className="text-muted-foreground mb-4">
                  Your intelligent legal document assistant. Select documents from the sidebar and start asking questions.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                  <Card className="p-3 hover:bg-accent/50 transition-colors cursor-pointer">
                    <p className="text-sm font-medium">Analyze contract terms</p>
                    <p className="text-xs text-muted-foreground">Review key clauses and obligations</p>
                  </Card>
                  <Card className="p-3 hover:bg-accent/50 transition-colors cursor-pointer">
                    <p className="text-sm font-medium">Summarize documents</p>
                    <p className="text-xs text-muted-foreground">Get concise overviews of lengthy documents</p>
                  </Card>
                  <Card className="p-3 hover:bg-accent/50 transition-colors cursor-pointer">
                    <p className="text-sm font-medium">Find specific information</p>
                    <p className="text-xs text-muted-foreground">Search across multiple documents</p>
                  </Card>
                  <Card className="p-3 hover:bg-accent/50 transition-colors cursor-pointer">
                    <p className="text-sm font-medium">Legal research</p>
                    <p className="text-xs text-muted-foreground">Get insights on legal precedents</p>
                  </Card>
                </div>
              </div>
            )}
          ...
          <form onSubmit={handleFormSubmit} className="max-w-4xl mx-auto">
            ...
            {selectedDocuments.length === 0 && (
              <p className="text-xs text-muted-foreground mt-2 text-center">
                💡 Tip: Select documents from the sidebar to enable context-aware responses
              </p>
            )}
          </form>
        </div>
