...
export function ComplianceIndicator({ 
  ...
  if (variant === 'card') {
    return (
      <Card className={cn("border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-900/10", className)}>
    ...
    <Card className={cn("border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-900/10", className)}>
      ...
      <CardContent className="space-y-3">
        {complianceItems.map((item) => (
          <div key={item.name} className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded-lg border">
