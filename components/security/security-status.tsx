...
export function SecurityStatus({ variant = 'detailed', className }: SecurityStatusProps) {
    ...
    <Card className={cn("border-green-200 bg-green-50/50 dark:border-green-800 dark:bg-green-900/10", className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg border">
          ...
          <div className={cn("text-3xl font-bold", getScoreColor(securityScore))}>
            {securityScore}/100
          </div>
          <Progress value={securityScore} className="mt-2" />
        ...
        <div className="space-y-2">
          ...
          {metrics.map((metric) => (
            <div key={metric.name} className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded-lg border">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Badge variant="outline" className="justify-center bg-green-50 border-green-200 text-green-800">
